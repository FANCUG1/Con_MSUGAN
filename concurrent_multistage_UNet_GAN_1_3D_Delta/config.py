...
def get_arguments():
    ...
    parser.add_argument('--min_size', type=int, help='image minimal size at the coarser scale', default=10)
    parser.add_argument('--max_size', type=int, help='image minimal size at the coarser scale', default=100)
    ...
    parser.add_argument('--niter', type=int, default=400, help='number of epochs to train per scale')
