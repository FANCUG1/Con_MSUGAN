...
def generate_samples(netG, reals_shapes, noise_amp, n=10):
    ...
    for idx in range(n):
        ...
        plt.imsave('%s/generated_sample_%d.png' % (dir2save_parent, idx + 1), functions.convert_image_np(sample.detach()), vmin=0, vmax=1)
...
if __name__ == '__main__':
    ...
    opt = parser.parse_args(['--model_dir', ''])  # add a path!
    _gpu = opt.gpu
